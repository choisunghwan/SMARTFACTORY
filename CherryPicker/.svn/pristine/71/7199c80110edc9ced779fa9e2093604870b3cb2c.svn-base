...
// 	alert("메인 : " + $('#gridData', parent.document).val());
	...
	$('#btnSearch').click(function () {
		fn_search("/PSMES/PSMES_UI520_search.do", "grid",setColumn,"100%");
	});
	...
	/*그리드 이벤트 끝*/
	//fn_search("/PSMES/PSMES_UI520_search.do", "grid",setColumn,"80%");
...
var setColumn = [
	...
	{ text: '직원코드'	, columntype: 'textbox', datafield: 'USER_ID'	, cellsalign: 'center', align: 'center',  width: '16%' },
	{ text: '이름'	, columntype: 'textbox', datafield: 'USER_NAME'	, cellsalign: 'center', align: 'center',  width: '16%' },
	{ text: '패스워드'	, columntype: 'textbox', datafield: 'USER_PW'	, cellsalign: 'center', align: 'center',  width: '16%' },
	{ text: '권한'			, columntype: 'combobox', datafield: 'USER_AUTH', displayfield: 'USER_AUTH_NM'		, cellsalign: 'center', align: 'center', width: '12%' ,
		createeditor: function (row, value, editor) {
            editor.jqxComboBox({ source: manageTpAdapter, displayMember: 'CD_NM', valueMember: 'CD_V' });
       }
	}, 
	
	{ text: '직급'	, columntype: 'textbox', datafield: 'USER_DISP'	, cellsalign: 'center', align: 'center',  width: '16%' },
	{
        text: '입사일', datafield: 'JOIN_DATE', columntype: 'datetimeinput',  align: 'center', cellsalign: 'center', cellsformat: 'yyyy-MM-dd',
...
var fn_save = function () {
  //저장 전 체크 
	...
	for(var i=0;i<rowindexes.length;i++)
	{
		...
		if($("#grid").jqxGrid('getcellvalue', rowindexes[i], "USER_ID") == "")
		{
			userIdCnt++;	
		}
		
		if($("#grid").jqxGrid('getcellvalue', rowindexes[i], "USER_PW") == "")
		{
			userPwCnt++;	
		}
							...
							<div class="form-row">
								<div class="col">
									...
									<select class="form-control"  name = "pUserAuth" id = "pUserAuth">
										...
										<option value="${manageTp.CD_V}">${manageTp.CD_NM}</option>
										</c:forEach>
									</select>
								</div>
