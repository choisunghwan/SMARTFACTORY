...
$(document).ready(function() {
	...
	$('#btnSearch').click(function () {
		fn_search("/PSMES/PSMES_UI510_search.do", "grid",setColumn,"100%");
	});
...
var setColumn = [
	...
	{ text: '구분'			, columntype: 'combobox', datafield: 'CUSTOMER_GUBUN', displayfield: 'CUSTOMER_GUBUN_NM', cellsalign: 'center', align: 'center', width: 60 , editable:false}, 
	{ text: '거래처명'			, columntype: 'textbox', datafield: 'CUSTOMER_NAME'	, cellsalign: 'left',   align: 'center',  width: 230 , editable:false},
	{ text: '사업자번호'		, columntype: 'textbox', datafield: 'REG_NO'		, cellsalign: 'center', align: 'center',  width: 180 , editable:false},
	{ text: '대표자명'			, columntype: 'textbox', datafield: 'CEO_NAME'		, cellsalign: 'center', align: 'center',  width: 80 , editable:false},
	{ text: 'TEL'			, columntype: 'textbox', datafield: 'TEL_NO'		, cellsalign: 'center', align: 'center',  width: 120 , editable:false},
	{ text: 'HP'			, columntype: 'textbox', datafield: 'FAX_NO'		, cellsalign: 'center', align: 'center',  width: 120 , editable:false},
	{ text: '주소'			, columntype: 'textbox', datafield: 'ADDRESS'		, cellsalign: 'left',   align: 'center',  editable:false},
...
function returnData(){
	...
	pArr[0] = $("#grid").jqxGrid('getcellvalue', rowindexes[0], "CUSTOMER_PK");
	pArr[1] = $("#grid").jqxGrid('getcellvalue', rowindexes[0], "CUSTOMER_NAME");;
