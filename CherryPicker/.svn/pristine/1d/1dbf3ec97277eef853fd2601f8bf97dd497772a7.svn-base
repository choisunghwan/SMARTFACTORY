...
$(document).ready(function() {
	...
	$('#btnSearch').click(function () {
		fn_search("/PSMES/PSMES_UI330_searchMas.do", "grid",setColumn,"100%");
// 		setGrid("grid2", "",setColumn2,"100%");
	...
	$('#btnExcel').click(function () {
		$("#grid").jqxGrid('exportdata', 'xlsx', '입고관리');
	});
...
var setColumn = [
	...
	{ text: '발주번호'		, columntype: 'textbox', datafield: 'P_ORDER_NO'	, cellsalign: 'center', align: 'center',  width: 120 , editable:false,  cellsrenderer: cellsrenderer},
	...
	{ text: '입고일자'		, columntype: 'textbox', datafield: 'STOCK_DATE'	, cellsalign: 'center', align: 'center',  width: 150 , editable:false},
...
<!-- 	<div id="container">	 -->
		...
		<div id="content" style="height:100%" id ="content">			
			<div class="content-inner hid" style="height:100%">
				<div class="inner_top">
					<h3 class="tit">입고관리</h3>
					<div class="top_btn">
						<a href="#n" class="btn1" id="btnStock" style="display: inline-block;">입고</a>
...
<!-- 									<input type = "hidden" name = "pCustomerPk" id = "pCustomerPk"  value="" readonly> -->
<!-- 									<button type="button" class="search_ico" id ="btnCustomerOpen" >검색</button>	 -->
								</div>
