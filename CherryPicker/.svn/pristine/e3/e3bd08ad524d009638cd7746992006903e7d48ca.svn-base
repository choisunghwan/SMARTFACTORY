...
$(document).ready(function() {
	...
	$('#btnSearch').click(function () {
		fn_search("/PSMES/PSMES_UI320_searchMas.do", "grid",setColumn, "100%", true);
// 		setGrid("grid2", "",setColumn2,"100%");
	...
	$('#grid').on('cellclick', function (event) {
	    ...
	    if(args.datafield == "P_ORDER_NO")
		{
			var value = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "P_ORDER_PK");
			
			if(value != null && value !="")
			{
				//사용일자 클릭 시 원료사용 상세정보로 이동
				window.parent.addTabNewLoad('/PSMES/PSMES_UI310.do?programId=PSMES_UI320', '발주 등록 및 조회', "", value, '','','','','');
...
var setColumn = [
	{ text: '순번'	, columntype: 'textbox', datafield: 'ROWNUM'		, cellsalign: 'center'	, align: 'center',  width: 50, editable:false},
 	{ text: '발주상태'	, columntype: 'textbox', datafield: 'ORDER_TP_NM'	, cellsalign: 'center'	, align: 'center',  width: 80, editable:false},
 	{ text: '발주번호'	, columntype: 'textbox', datafield: 'P_ORDER_NO'	, cellsalign: 'center'	, align: 'center',  width: 150 , editable:false,  cellsrenderer: cellsrenderer},
	{ text: '발주명'	, columntype: 'textbox', datafield: 'P_ORDER_NAME'	, cellsalign: 'left'	, align: 'center', editable:false},
	{ text: '업체명'	, columntype: 'textbox', datafield: 'CUSTOMER_NAME'	, cellsalign: 'left'	, align: 'center',  width: 300 , editable:false},
	{ text: '발주일자'	, columntype: 'textbox', datafield: 'P_ORDER_DATE'	, cellsalign: 'center'	, align: 'center',  width: 150 , editable:false},
	{ text: '납기일자'	, columntype: 'textbox', datafield: 'FIXED_DATE'	, cellsalign: 'center'	, align: 'center',  width: 150 , editable:false},
	{ text: '견적가'	, columntype: 'numberinput', datafield: 'ESTIMATED_COST', cellsalign: 'right'	, align: 'center',  width: 150 , editable:false, cellsformat: 'D', 
		aggregates: ["sum"],
	...
	{ text: '결정가'	, columntype: 'numberinput', datafield: 'FINAL_COST'	, cellsalign: 'right'	, align: 'center',  width: 150 , editable:false, cellsformat: 'D',
		aggregates: ["sum"],
		aggregatesrenderer: function (aggregates) {  
			var vSum = aggregates.sum;
		    if(vSum == undefined) vSum = "";
	...
	{ text: 'P_ORDER_PK'	, columntype: 'textbox', datafield: 'P_ORDER_PK'	, hidden: true }
];
...
<!-- 								</div> -->
								...
								<div class="col">
									...
									<select class="form-control"  name = "pOrderTp" id = "pOrderTp">
										...
										<option value="${orderTp.CD_V}">${orderTp.CD_NM}</option>
										</c:forEach>
									</select>
								</div>
