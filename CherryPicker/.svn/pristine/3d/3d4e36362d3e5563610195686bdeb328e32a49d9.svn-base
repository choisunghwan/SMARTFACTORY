...
//		mv.addObject("accountTpGrid", list1);
    ...
    public ModelAndView CPMES_UI510_save(CommandMap commandMap, HttpServletRequest request) throws Exception{
		...
		for(int i=0; i<iCnt; i++){
			...
			if("1".equals(chk))
			{
				smap.put("CUSTOMER_PK_CP", CommonUtils.isNull(jsonObj.get("CUSTOMER_PK_CP")));
				smap.put("CUSTOMER_GUBUN_CP", CommonUtils.isNull(jsonObj.get("CUSTOMER_GUBUN_CP")));
				smap.put("CUSTOMER_TP_CP", CommonUtils.isNull(jsonObj.get("CUSTOMER_TP_CP")));
				smap.put("CUSTOMER_NAME_CP", CommonUtils.isNull(jsonObj.get("CUSTOMER_NAME_CP")));
				smap.put("REG_NO_CP", CommonUtils.isNull(jsonObj.get("REG_NO_CP")));
				smap.put("CEO_NAME_CP", CommonUtils.isNull(jsonObj.get("CEO_NAME_CP")));
				smap.put("TEL_NO_CP", CommonUtils.isNull(jsonObj.get("TEL_NO_CP")));
				smap.put("FAX_NO_CP", CommonUtils.isNull(jsonObj.get("FAX_NO_CP")));
				smap.put("ADDRESS_CP", CommonUtils.isNull(jsonObj.get("ADDRESS_CP")));
				smap.put("REMARKS_CP", CommonUtils.isNull(jsonObj.get("REMARKS_CP")));
...
//		int iCnt = jsonArray.size();
    ...
    public ModelAndView CPMES_UI520_save(CommandMap commandMap, HttpServletRequest request) throws Exception{
		...
		for(int i=0; i<iCnt; i++){
			...
			if("1".equals(chk))
			{
				smap.put("USER_ID_CP", CommonUtils.isNull(jsonObj.get("USER_ID_CP")));
				smap.put("USER_NAME_CP", CommonUtils.isNull(jsonObj.get("USER_NAME_CP")));
				smap.put("USER_PW_CP", CommonUtils.isNull(jsonObj.get("USER_PW_CP")));
				smap.put("USER_AUTH_CP", CommonUtils.isNull(jsonObj.get("USER_AUTH_CP")));
				smap.put("USER_DISP_CP", CommonUtils.isNull(jsonObj.get("USER_DISP_CP")));
				smap.put("JOIN_DATE_CP", CommonUtils.isNull(jsonObj.get("JOIN_DATE_CP")));
				smap.put("CREATE_USER_CP", sUserId);
				smap.put("UPDATE_USER_CP", sUserId);
...
///////
    ...
    public ModelAndView CPMES_UI530_save(CommandMap commandMap, HttpServletRequest request) throws Exception{
		...
		for(int i=0; i<iCnt; i++){
			...
			if("1".equals(chk))
			{
				smap.put("CD_TP_CP", CommonUtils.isNull(jsonObj.get("CD_TP_CP")));
				smap.put("CD_V_CP", CommonUtils.isNull(jsonObj.get("CD_V_CP")));
				smap.put("CD_NM_CP", CommonUtils.isNull(jsonObj.get("CD_NM_CP")));
		...
		for(int i=0; i<iCnt2; i++){
			...
			if("1".equals(chk))
			{
				...
				smap.put("CD_V_CP", CommonUtils.isNull(jsonObj.get("CD_V_CP")));
				smap.put("CD_NM_CP", CommonUtils.isNull(jsonObj.get("CD_NM_CP")));
				smap.put("ATTR1_CP", CommonUtils.isNull(jsonObj.get("ATTR1_CP")));
				smap.put("ATTR2_CP", CommonUtils.isNull(jsonObj.get("ATTR2_CP")));
				smap.put("ATTR3_CP", CommonUtils.isNull(jsonObj.get("ATTR3_CP")));
				smap.put("ATTR4_CP", CommonUtils.isNull(jsonObj.get("ATTR4_CP")));
    ...
    public ModelAndView CPMES_UI530_del(CommandMap commandMap, HttpServletRequest request) throws Exception{
		...
		for(int i=0; i<iCnt; i++){
			...
			if("1".equals(chk))
			{
				String cdtp = CommonUtils.isNull(jsonObj.get("CD_TP_CP"));
