...
//var DEFAULT_URL = 'code001.pdf';


//var DEFAULT_URL = 'shipping1.pdf';
var DEFAULT_URL = '';
 ...
 (function () {
  ...
  (function (root, factory) {
   ...
   function webViewerInitialized() {
    ...
    //file = 'file' in params ? '/output/'+params.file : DEFAULT_URL;
    file = 'file' in params ? '/pdf/web'+params.file : DEFAULT_URL;
