...
$(document).ready(function() {
	...
	$('#btnSearch').click(function () {
		fn_search("/PSMES/PSMES_UI220_searchMas.do", "grid",setColumn,"100%", true);
	...
	$('#grid').on('cellclick', function (event) {
	    ...
	    if(args.datafield == "R_ORDER_NO")
		{
			var value = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "R_ORDER_PK");
			
			if(value != null && value !="")
			{
				//사용일자 클릭 시 원료사용 상세정보로 이동
				window.parent.addTabNewLoad('/PSMES/PSMES_UI210.do?programId=PSMES_UI220', '수주 등록 및 조회', "", value, '','','','','');
			}
		}
	});
...
var setColumn = [
	{ text: '순번'		,  columntype: 'textbox'	,  datafield: 'ROWNUM'			, cellsalign: 'center'	, align: 'center',  width: 50, editable:false},
 	{ text: '상태'		,  columntype: 'textbox'	,  datafield: 'SALES_TP'		, cellsalign: 'center'	, align: 'center',  width: 80, editable:false},
	{ text: '수주번호'		,  columntype: 'textbox'	,  datafield: 'R_ORDER_NO'		, cellsalign: 'center'	, align: 'center',  width: 150, editable:false,  cellsrenderer: cellsrenderer },
	{ text: '수주명'		,  columntype: 'textbox'	,  datafield: 'R_ORDER_NAME'	, cellsalign: 'left'	, align: 'center',  editable:false},
	{ text: '업체명'		,  columntype: 'textbox'	,  datafield: 'COMPANY_NAME'	, cellsalign: 'left'	, align: 'center',  width: 300 , editable:false},
	{ text: '수주일자'		,  columntype: 'textbox'	,  datafield: 'R_ORDER_DATE'	, cellsalign: 'center'	, align: 'center',  width: 120 , editable:false},
	{ text: '납기일자'		,  columntype: 'textbox'	,  datafield: 'FIXED_DATE'		, cellsalign: 'center'	, align: 'center',  width: 120 , editable:false},
	...
	{ text: '외주'	    ,  columntype: 'numberinput',  datafield: 'OUT_COST'		, cellsalign: 'right'	, align: 'center',  width: 150 , editable:false, cellsformat: 'D',
		aggregates: ["sum"],
		aggregatesrenderer: function (aggregates) {  
			var vSum = aggregates.sum;
		    if(vSum == undefined) vSum = "";
	...
	{ text: '일반관리비'	,  columntype: 'numberinput',  datafield: 'GENERAL_COST'	, cellsalign: 'right'	, align: 'center',  width: 150 , editable:false, cellsformat: 'D',
		aggregates: ["sum"],
		aggregatesrenderer: function (aggregates) {  
			var vSum = aggregates.sum;
		    if(vSum == undefined) vSum = "";
