...
$(document).ready(function() {
	...
	$('#btnSearch').click(function () {
		fn_search("/PSMES/PSMES_UI530_searchMas.do", "grid",setColumn,"80%");
		setGrid("grid2", "",setColumn2,"80%");
	});
	...
	$('#grid').on('cellclick', function (event) {
	    ...
	    if(args.datafield == "CD_NM")
		{
			...
			if(value != null && value !="")
			{
				...
				fn_search("/PSMES/PSMES_UI530_searchDet.do", "grid2",setColumn2,"80%");	
			}
...
var setColumn = [
	...
	{ text: '직원코드'	, columntype: 'textbox', datafield: 'COL1'	, cellsalign: 'center', align: 'center',  width: '16%' },
	{ text: '이름'	, columntype: 'textbox', datafield: 'COL2'	, cellsalign: 'center', align: 'center',  width: '16%' },
	{ text: '패스워드'	, columntype: 'textbox', datafield: 'COL3'	, cellsalign: 'center', align: 'center',  width: '16%' },
	{ text: '권한'	, columntype: 'textbox', datafield: 'COL4'	, cellsalign: 'center', align: 'center',  width: '16%' },
	{ text: '직급'	, columntype: 'textbox', datafield: 'COL5'	, cellsalign: 'center', align: 'center',  width: '16%' },
	{ text: '입사일'	, columntype: 'textbox', datafield: 'COL6'	, cellsalign: 'center', align: 'center',  width: '15%' },
			...
			<div class="content-inner hid" style="height:100%">
				<div class="inner_top">
					...
					<div class="top_btn">
						...
						<a href="#n" class="btn1" id="btnSearch" style="display: inline-block;">신규</a>
						<a href="#n" class="btn1" id="btnSave" style="display: inline-block;">저장</a>
						<a href="#n" class="btn1" id="btnSearch" style="display: inline-block;">삭제</a>
...
<%-- 									<input type="text" name="pSearchStaDt" id="datepicker"  value="<%=pSearchStaDt %>" class="form-control" style="width:120px;"> --%>
<!-- 									<button type="button" class="date_ico" id ="fa-calendar" >달력</button> -->
<!-- 								</div>	 -->
<!-- 								<div class="col"> -->
<!-- 									<div class="divider">~</div> -->
<%-- 									<input type="text" name="pSearchEndDt"  id="datepicker1" value="<%=pSearchEndDt %>" class="form-control" style="width:120px;" > --%>
