...
$(document).ready(function() {
	...
	$('#btnSearch').click(function () {
		fn_search("/PSMES/PSMES_UI230_searchMas.do", "grid",setColumn,"100%");
...
var setColumn = [
	{ text: '순번'		, columntype: 'textbox', datafield: 'ROWNUM'			, cellsalign: 'center', align: 'center',  width: 50,  editable:false},
 	{ text: '상태'		, columntype: 'textbox', datafield: 'SALES_TP'			, cellsalign: 'center', align: 'center',  width: 100, editable:false},
	{ text: '수주번호'		, columntype: 'textbox', datafield: 'R_ORDER_NO'		, cellsalign: 'center', align: 'center',  width: 180, editable:false, cellsrenderer: cellsrenderer },
	...
	{ text: '작업시작일자'	, columntype: 'textbox', datafield: 'P_WORK_START_DATE'	, cellsalign: 'center', align: 'center',  width: 120, editable:false },
	{ text: '작업완료일자'	, columntype: 'textbox', datafield: 'P_WORK_END_DATE'	, cellsalign: 'center', align: 'center',  width: 120, editable:false },
	{ text: '출고일자'		, columntype: 'textbox', datafield: 'SHIPPING_DATE'		, cellsalign: 'center', align: 'center',  width: 120, editable:false },
