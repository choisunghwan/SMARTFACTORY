...
$(document).ready(function() {
	...
	$('#btnSearch').click(function () {
		fn_search("/PSMES/PSMES_UI214_searchList.do", "grid",setColumn,"80%");
	});
	...
	$('#grid').on('cellclick', function (event) {
	    ...
	    if(dataField == "FILE_NM")
	    {  
	    	if($("#grid").jqxGrid('getcellvalue', rowBoundIndex, "DRAWING_FILE") != "" ){
		    	location.href = "/PSMES/PSMES_UI210_FileDown.do?filePath="+$('#pROrderPk').val()+"&fileName="+$("#grid").jqxGrid('getcellvalue', rowBoundIndex, "FILE_NM");
	    	}
	    }
	});
...
var setColumn = [
	...
	{ text: '수주명'				, columntype: 'textbox', datafield: 'R_ORDER_NAME'	, cellsalign: 'center', align: 'center',  width: '200' ,editable:false},
	{ text: '파일명'				, columntype: 'textbox', datafield: 'FILE_NM'		, cellsalign: 'center', align: 'center',  width: '450' ,cellsrenderer: cellsrenderer,editable:false},
	{ text: 'R_ORDER_FILE_PK'	, columntype: 'textbox', datafield: 'R_ORDER_FILE_PK'	, hidden: true },
...
var fn_del = function()
{
  ...
  //로딩이미지 오픈
	...
	$.ajax({
      url: "/PSMES/PSMES_UI214_delete.do",
      dataType: 'json',
