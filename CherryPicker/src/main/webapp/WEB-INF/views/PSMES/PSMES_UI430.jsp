...
$(document).ready(function() {
	...
	$('#btnSearch').click(function () {
		fn_search("/PSMES/PSMES_UI430_main_search.do", "grid", setColumn, "100%");
	...
	$('#grid').on('cellclick', function (event) {
	    ...
	    var cv_EQUIPMENT_PK = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "EQUIPMENT_PK");
	    var cv_EQUIP_CODE = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "EQUIP_CODE");
	    var cv_EQUIP_NAME = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "EQUIP_NAME");
	    var cv_MAKER = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "MAKER");
	    var cv_SUPPLIER = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "SUPPLIER");
	    var cv_SUPPLY_DATE = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "SUPPLY_DATE");
	    var cv_INSTALL_DATE = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "INSTALL_DATE");
	    var cv_MANAGER = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "MANAGER");
	    var cv_EQUIP_AMOUNT = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "EQUIP_AMOUNT");
	    var cv_CALIBARTION_YN = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "CALIBARTION_YN");
	    var cv_USE_YN = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "USE_YN");
	    var cv_NOTE = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "NOTE");
		...
		// 관리이력 조회
		fn_search("/PSMES/PSMES_UI430_detail_search.do", "grid2", setColumn2, "100%");
...
var setColumn = [
	...
	{ text: '설비코드'	, columntype: 'textbox', datafield: 'EQUIP_CODE', cellsalign: 'center', align: 'center',  width: 120, editable: false },
	{ text: '설비명'	, columntype: 'textbox', datafield: 'EQUIP_NAME', cellsalign: 'center', align: 'center', editable: false },
	{ text: '설비PK'	, columntype: 'textbox', datafield: 'EQUIPMENT_PK',		hidden: true },
	{ text: '제조사'	, columntype: 'textbox', datafield: 'MAKER', 			hidden: true },
	{ text: '납품사'	, columntype: 'textbox', datafield: 'SUPPLIER', 		hidden: true },
	{ text: '납품일'	, columntype: 'textbox', datafield: 'SUPPLY_DATE', 		hidden: true },
	{ text: '설치일'	, columntype: 'textbox', datafield: 'INSTALL_DATE', 	hidden: true },
	{ text: '관리자'	, columntype: 'textbox', datafield: 'MANAGER', 			hidden: true },
	{ text: '구입금액'	, columntype: 'textbox', datafield: 'EQUIP_AMOUNT', 	hidden: true },
	{ text: '검정여부'	, columntype: 'textbox', datafield: 'CALIBARTION_YN', 	hidden: true },
	{ text: '사용유무'	, columntype: 'textbox', datafield: 'USE_YN', 			hidden: true },
	{ text: '비고'	, columntype: 'textbox', datafield: 'NOTE', 			hidden: true },
...
var setColumn2 = [
	{
 	...
 	{ 
		text: '일자', datafield: 'HISTORY_DATE', columntype: 'datetimeinput',  align: 'center', cellsalign: 'center', width: 150, cellsformat: 'yyyy-MM-dd',
 	...
 	{ text: '관리이력'	, columntype: 'textbox', datafield: 'REMARKS'	, cellsalign: 'left', align: 'center'},
 	{ text: '설비관리PK', columntype: 'textbox', datafield: 'EQUIPMENT_DETAIL_PK',		hidden: true },
	{ text: 'CHK'	, columntype: 'textbox', datafield: 'CHK'	, hidden: true }
];
      ...
      success: function (data) {
			...
			if($('#pEquipmentPk').val() == "")
			{
				...
				for(i=0; i<gridrows.length; i++){
					...
					var EQUIPMENT_PK = $('#grid').jqxGrid('getcellvalue', i, "EQUIPMENT_PK");
				    var EQUIP_CODE = $('#grid').jqxGrid('getcellvalue', i, "EQUIP_CODE");
				    var EQUIP_NAME = $('#grid').jqxGrid('getcellvalue', i, "EQUIP_NAME");
					
				    var txtEquipCode = $('#pEquipCode').val();
				    var txtEquipName = $('#pEquipName').val();
				    
				    if(EQUIP_CODE == txtEquipCode && EQUIP_NAME == txtEquipName){
				    	$('#pEquipmentPk').val(EQUIPMENT_PK);
				    	break;
				    }
...
var fn_del = function(grid_id)
{
	...
	$.ajax({
      url: "/PSMES/PSMES_UI430_main_delete.do",
      dataType: 'json',
      data : $("#form1").serialize(),
		//data : param,
      type : 'POST',
...
var fn_del2 = function(grid_id)
{
  ...
  //로딩이미지 오픈
	...
	$.ajax({
      url: "/PSMES/PSMES_UI430_detail_delete.do",
      dataType: 'json',
      data : $("#form1").serialize(),
		//data : param,
      type : 'POST',
