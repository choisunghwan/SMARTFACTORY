...
$(document).ready(function() {
	...
	$('#btnSearch').click(function () {
		fn_search("/CPMES/CPMES_UI710_search.do", "grid",setColumn,"100%");
...
var setColumn = [
	...
	{ text: '시간'		, columntype: 'textbox', datafield: 'LOG_PASSTIME_CP'		, cellsalign: 'center', align: 'center',  width: 400, editable: false  },
	{ text: '방향'		, columntype: 'textbox', datafield: 'LOG_PASS_CONTENT_CP'		, cellsalign: 'center', align: 'center',  width: 300, editable: false  },
	{ text: '총 수'		, columntype: 'textbox', datafield: 'LOG_PASS_COUNT_CP'		, cellsalign: 'center', align: 'center', editable: false  },
