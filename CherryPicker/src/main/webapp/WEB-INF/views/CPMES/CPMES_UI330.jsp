...
$(document).ready(function() {
	...
	$('#btnSearch').click(function () {
		fn_search("/CPMES/CPMES_UI330_searchMas.do", "grid",setColumn,"100%");
...
var setColumn = [
	...
	{ text: '발주번호'		, columntype: 'textbox', datafield: 'P_ORDER_NO_CP'	, cellsalign: 'center', align: 'center',  width: 120 , editable:false,  cellsrenderer: cellsrenderer},
	...
	{ text: '입고일자'		, columntype: 'textbox', datafield: 'STOCK_DATE_CP'	, cellsalign: 'center', align: 'center',  width: 150 , editable:false},
