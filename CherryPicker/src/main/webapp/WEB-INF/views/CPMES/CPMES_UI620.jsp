...
$(document).ready(function() {
	...
	$('#btnSearch').click(function () {
		fn_search("/CPMES/CPMES_UI620_searchuser.do", "grid",setColumn,"100%");
	...
	$('#grid').on('cellclick', function (event) {
	    ...
	    if(args.datafield == "USER_NAME_CP")
		{
			var value = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "USER_ID_CP");
			...
			if(value != null && value !="")
			{
				...
				fn_search("/CPMES/CPMES_UI620_searchList.do", "grid2",setColumn2,"100%");	
			}
...
var setColumn = [
	...
	{ text: '작업자명'	, columntype: 'textbox', datafield: 'USER_NAME_CP'	, cellsalign: 'center', align: 'center',  width: 150 ,  cellsrenderer: cellsrenderer, editable: false },
// 	{ text: '명칭'	, columntype: 'textbox', datafield: 'CD_NM'	, cellsalign: 'center', align: 'center',  cellsrenderer: cellsrenderer},
	{ text: 'USER_ID_CP'	, columntype: 'textbox', datafield: 'USER_ID_CP'	, hidden: true },
...
var setColumn2 = [
	{
 	...
 	{ text: '수주명'	, columntype: 'textbox', datafield: 'R_ORDER_NAME_CP'		, cellsalign: 'center', align: 'center', editable: false },
	{ text: '품번'	, columntype: 'textbox', datafield: 'PRODUCT_NO_CP'		, cellsalign: 'center', align: 'center', width: 120, editable: false },
	{ text: '품명'	, columntype: 'textbox', datafield: 'PRODUCT_NAME_CP'		, cellsalign: 'center', align: 'center', width: 120, editable: false },
	{ text: '작업구분'	, columntype: 'textbox', datafield: 'WORK_STATUS_CP'		, cellsalign: 'center', align: 'center', width: 120, editable: false },
	{ text: '계획일자'	, columntype: 'textbox', datafield: 'P1_PLAN_DATE_CP'		, cellsalign: 'center', align: 'center', width: 100, editable: false },
	{ text: '시작일자'	, columntype: 'textbox', datafield: 'P1_WORK_START_DATE_CP', cellsalign: 'center', align: 'center', width: 100, editable: false },
	{ text: '완료일자'	, columntype: 'textbox', datafield: 'P1_WORK_END_DATE_CP'	, cellsalign: 'center', align: 'center', width: 100, editable: false },
	{ text: 'CHK'	, columntype: 'textbox', datafield: 'CHK'	, hidden: true }
];
