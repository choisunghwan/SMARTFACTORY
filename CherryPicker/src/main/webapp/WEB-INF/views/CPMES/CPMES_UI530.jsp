...
var setColumn = [
	...
	{ text: '코드분류'	, columntype: 'textbox', datafield: 'CD_V_CP'	, cellsalign: 'center', align: 'center',  width: 150 },
	{ text: '명칭'	, columntype: 'textbox', datafield: 'CD_NM_CP'	, cellsalign: 'center', align: 'center',  cellsrenderer: cellsrenderer},
	{ text: 'CD_TP_CP'	, columntype: 'textbox', datafield: 'CD_TP_CP'	, hidden: true },
...
var setColumn2 = [
	{
 	...
 	{ text: '코드분류'	, columntype: 'textbox', datafield: 'CD_TP_CP'	, cellsalign: 'center', align: 'center', width: 150, editable: false },	
 	{ text: '코드종류'	, columntype: 'textbox', datafield: 'CD_V_CP'	, cellsalign: 'center', align: 'center', width: 150},
	{ text: '명칭'	, columntype: 'textbox', datafield: 'CD_NM_CP'	, cellsalign: 'center', align: 'center'},
	{ text: '속성1'	, columntype: 'textbox', datafield: 'ATTR1_CP'	, cellsalign: 'center', align: 'center', width: 120},
	{ text: '속성2'	, columntype: 'textbox', datafield: 'ATTR2_CP'	, cellsalign: 'center', align: 'center', width: 120},
	{ text: '속성3'	, columntype: 'textbox', datafield: 'ATTR3_CP'	, cellsalign: 'center', align: 'center', width: 120},
	{ text: '속성4'	, columntype: 'textbox', datafield: 'ATTR4_CP'	, cellsalign: 'center', align: 'center', width: 120},
	{ text: 'CHK'	, columntype: 'textbox', datafield: 'CHK'	, hidden: true }
];
...
var fn_save = function () {
  //저장 전 체크 
	...
	for(var i=0;i<rowindexes2.length;i++)
	{
		...
		if($("#grid2").jqxGrid('getcellvalue', rowindexes2[i], "CD_V_CP") == "")
		{
			cdtpCnt2++;	
		}
		
		if($("#grid2").jqxGrid('getcellvalue', rowindexes2[i], "CD_NM_CP") == "")
		{
			cdNmCnt2++;	
		}
