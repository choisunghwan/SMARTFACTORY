...
$(document).ready(function() {
	...
	$('#btnSearch').click(function () {
		fn_search("/CPMES/CPMES_UI720_search.do", "grid",setColumn,"100%");
...
var setColumn = [
	...
	{ text: '시간'		, columntype: 'textbox', datafield: 'DEFECTIVE_DETECT_LOG_TIME_CP'		, cellsalign: 'center', align: 'center',  width: 400, editable: false  },
	{ text: '불량 물품명'		, columntype: 'textbox', datafield: 'DEFECTIVE_DETECT_NAME_CP'		, cellsalign: 'center', align: 'center',  width: 300, editable: false  },
	{ text: '총 불량 물품 수'		, columntype: 'textbox', datafield: 'DEFECTIVE_DETECT_COUNT_CP'		, cellsalign: 'center', align: 'center', editable: false  },
