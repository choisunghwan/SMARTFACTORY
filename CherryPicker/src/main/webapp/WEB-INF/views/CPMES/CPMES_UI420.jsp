...
$(document).ready(function() {
	...
	$('#btnSearch').click(function () {
		fn_search_n("/CPMES/CPMES_UI420_main_search.do", "grid",setColumn,"100%");
	...
	$('#grid').on('cellclick', function (event) {
	    ...
	    var cv_R_ORDER_PK_CP = $('#grid').jqxGrid('getcellvalue', rowBoundIndex, "R_ORDER_PK_CP");
	    
	    $('#pROrderPk').val(cv_R_ORDER_PK_CP);	// 수주번호PK
	    
	    fn_search("/CPMES/CPMES_UI420_detail_search.do", "grid2", setColumn2, "100%");
...
var setColumn = [
	{
 	...
 	{ text: '수주상태'		, columntype: 'textbox', datafield: 'SALES_NM_CP'		, cellsalign: 'center', align: 'center',  width: 80, editable: false },
 	{ text: '수주번호'		, columntype: 'textbox', datafield: 'R_ORDER_NO_CP'	, cellsalign: 'center', align: 'center',  width: 100, editable: false },
	{ text: '수주명'		, columntype: 'textbox', datafield: 'R_ORDER_NAME_CP'	, cellsalign: 'left'  , align: 'center', editable: false },
	{ text: '수주일자'		, columntype: 'textbox', datafield: 'R_ORDER_DATE_V_CP', cellsalign: 'center', align: 'center',  width: 100, editable: false },
	{ text: '납기일'		, columntype: 'textbox', datafield: 'FIXED_DATE_CP'	, cellsalign: 'center', align: 'center',  width: 100, editable: false },
	{ text: '작업'		, columntype: 'textbox', datafield: 'WORK_CONFIRM_CP'	, cellsalign: 'center', align: 'center',  width: 40, editable: false },
	{ text: '수주PK'		, columntype: 'textbox', datafield: 'R_ORDER_PK_CP'	, hidden: true },
	{ text: 'CHK'		, columntype: 'textbox', datafield: 'CHK'			, hidden: true },
	{ text: 'SALES_TP'	, columntype: 'textbox', datafield: 'SALES_TP_CP'		, hidden: true }
];
...
//그리드 컬럼 셋팅
var setColumn2 = [
	{ text: '품번'	, columntype: 'textbox', datafield: 'PRODUCT_NO_CP'		, cellsalign: 'center', align: 'center', width: 80, pinned: true, editable: false},
	{ text: '품명'	, columntype: 'textbox', datafield: 'PRODUCT_NAME_CP'		, cellsalign: 'left'  , align: 'center', width: 150, pinned: true, editable: false },
	{ text: '작업'	, columntype: 'textbox', datafield: 'WORK_CONFIRM_CP'		, cellsalign: 'center', align: 'center', width: 40 , pinned: true, editable: false },
 	{ text: '계획일'	, columntype: 'textbox', datafield: 'P1_PLAN_DATE_CP'		, cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails1'},
	{ text: '작업자'	, columntype: 'textbox', datafield: 'P1_WORKER_CP'			, cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails1'},
	{ text: '작업시작'	, columntype: 'textbox', datafield: 'P1_WORK_START_DATE_CP', cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails1'},
	{ text: '작업완료'	, columntype: 'textbox', datafield: 'P1_WORK_END_DATE_CP'	, cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails1'},
	{ text: '계획일'	, columntype: 'textbox', datafield: 'P2_PLAN_DATE_CP'		, cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails2'},
	{ text: '작업자'	, columntype: 'textbox', datafield: 'P2_WORKER_CP'			, cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails2'},
	{ text: '작업시작'	, columntype: 'textbox', datafield: 'P2_WORK_START_DATE_CP', cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails2'},
	{ text: '작업완료'	, columntype: 'textbox', datafield: 'P2_WORK_END_DATE_CP'	, cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails2'},
	{ text: '계획일'	, columntype: 'textbox', datafield: 'P3_PLAN_DATE_CP'		, cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails3'},
	{ text: '작업자'	, columntype: 'textbox', datafield: 'P3_WORKER_CP'			, cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails3'},
	{ text: '작업시작'	, columntype: 'textbox', datafield: 'P3_WORK_START_DATE_CP', cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails3'},
	{ text: '작업완료'	, columntype: 'textbox', datafield: 'P3_WORK_END_DATE_CP'	, cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails3'},
	{ text: '계획일'	, columntype: 'textbox', datafield: 'P4_PLAN_DATE_CP'		, cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails4'},
	{ text: '작업자'	, columntype: 'textbox', datafield: 'P4_WORKER_CP'			, cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails4'},
	{ text: '작업시작'	, columntype: 'textbox', datafield: 'P4_WORK_START_DATE_CP', cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails4'},
	{ text: '작업완료'	, columntype: 'textbox', datafield: 'P4_WORK_END_DATE_CP'	, cellsalign: 'center', align: 'center', width: 100, editable: false, columngroup: 'ProductDetails4'},
	{ text: 'R_ORDER_PK'	    , columntype: 'textbox', datafield: 'R_ORDER_PK_CP'		, hidden: true },
	{ text: 'R_ORDER_DETAIL_PK'	, columntype: 'textbox', datafield: 'R_ORDER_DETAIL_PK_CP'	, hidden: true },
	{ text: 'CHK'			    , columntype: 'textbox', datafield: 'CHK'				, hidden: true }
];
...
var fn_save = function () {
  //저장 전 체크 
	...
	for(var i=0;i<rowindexes.length;i++)
	{
		...
		vOrderNo = $("#grid").jqxGrid('getcellvalue', rowindexes[i], "R_ORDER_NO_CP");
		vWorkConfirm = $("#grid").jqxGrid('getcellvalue', rowindexes[i], "WORK_CONFIRM_CP");
		vSalestp =  $("#grid").jqxGrid('getcellvalue', rowindexes[i], "SALES_TP_CP"); 
	}
...
//       	xmlHttpRequest.setRequestHeader("AJAX", "true");
      ...
      success: function (data) {
          ...
          fn_search_n("/CPMES/CPMES_UI420_searchMas.do", "grid",setColumn,"100%");
