...
public class UI400Service	{
	...
	// 작업지시
	//////////////////////////////////////////////////
	public void CPMES_UI410_save(List<Map<String, Object>> list) throws Exception  {
		// TODO Auto-generated method stub
		for(int i=0, size=list.size(); i<size; i++){
			UI400DAO.CPMES_UI410_save(list.get(i));
		}
	}
	
	public void CPMES_UI410_save_status(Map<String, Object> map) throws Exception  {
		// TODO Auto-generated method stub
		UI400DAO.CPMES_UI410_save_status(map);
	}
	...
	public List<Map<String, Object>> CPMES_UI410_search(Map<String, Object> map)  throws Exception {
		return  UI400DAO.CPMES_UI410_search(map);
	}
	
	public List<Map<String, Object>> CPMES_UI410_searchWorkDateList()  throws Exception {
		// TODO Auto-generated method stub
		return  UI400DAO.CPMES_UI410_searchWorkDateList();
	}
	...
	public List<Map<String, Object>> CPMES_UI420_main_search(Map<String, Object> map) throws Exception {
		return  UI400DAO.CPMES_UI420_main_search(map);
	}
	
	public List<Map<String, Object>> CPMES_UI420_detail_search(Map<String, Object> map) throws Exception {
		return  UI400DAO.CPMES_UI420_detail_search(map);
	}
	
	public void CPMES_UI420_save(List<Map<String, Object>> list) throws Exception {
		for(int i=0, size=list.size(); i<size; i++){
			UI400DAO.CPMES_UI420_save(list.get(i));
		}
	}
	
	public void CPMES_UI420_WORK_LIST_save(Map<String, Object> map) throws Exception {
		
		UI400DAO.CPMES_UI420_WORK_LIST_save(map);
